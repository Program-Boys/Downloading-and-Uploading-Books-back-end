...
var CreateBookService = /** @class */ (function () {
    ...
    CreateBookService.prototype.execute = function (_a) {
        var name = _a.name, gender = _a.gender;
        return __awaiter(this, void 0, void 0, function () {
            var createdAt, updatedAt, bookCreate, book;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        createdAt = new Date();
                        updatedAt = new Date();
                        bookCreate = book_1.Book.create({ name: name, gender: gender, createdAt: createdAt, updatedAt: updatedAt });
                        return [4 /*yield*/, this.booksRepository.create(bookCreate)];
                    case 1:
                        book = _b.sent();
